...
void main() {
  testWidgets('Full navigation test', (WidgetTester tester) async {
    ...
    // Tap Add Product card
    final addProductText = find.text('Add Product');
    expect(addProductText, findsWidgets);
    await tester.tap(addProductText.first);
    await tester.pumpAndSettle();
